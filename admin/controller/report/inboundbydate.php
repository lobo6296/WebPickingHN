<?php
class ControllerReportinboundbydate extends Controller {
	...
	public function download() {
		...
		$filter_data = array(
		 ...
		 $this->response->redirect($this->url->link('report/inboundbydate', 'token=' . $this->session->data['token'] . $url, true));
		}
		$this->index();		
	}
	...
	public function index() {
		$this->load->language('report/inboundbydate');
		...
		$data['pdf'] = $this->url->link('report/inboundbydate/pdf', 'token=' . $this->session->data['token'].$url, 'SSL');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/inboundbydate', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$stock_total = $this->model_report_tigo->getTotalInboundbydate($filter_data);

		$results = $this->model_report_tigo->getInboundbydate($filter_data);
		...
		$data['export'] = $this->url->link('report/inboundbydate/download', 'token=' . $this->session->data['token'], true);
		
		$data['excel'] = $this->url->link('report/inboundbydate/excel', 'token=' . $this->session->data['token'], 'SSL');
		...
		$pagination->url = $this->url->link('report/inboundbydate', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
        ...
        /*
		if ($pdf) {
          $this->response->setOutput(pdf($this->load->view('report/inboundbydate.tpl', $data),$data));
		} else {
		*/	
		  $this->response->setOutput($this->load->view('report/inboundbydate.tpl', $data));
		/*
		}
		*/
	}
