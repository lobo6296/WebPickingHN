...
class ControllerDesignTranslation extends Controller {
    ...
    public function refresh(){
		$request = 'json=true';
		//$curl = curl_init('https://api.crowdin.com/api/project//download/zh-CN.zip?key=a00e7b58c0790df4126273119b318db5');

        $curl = curl_init('https://api.crowdin.com/api/project//status?key=a00e7b58c0790df4126273119b318db5');
	...
	file_put_contents("translations.zip", file_get_contents("https://api.crowdin.com/api/project//download/" . $this->request->get['code'] . ".zip?key=a00e7b58c0790df4126273119b318db5"));
