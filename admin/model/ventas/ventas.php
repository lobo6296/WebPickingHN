...
class ModelSaleOrder extends Model {
	public function getVentaPlanes($numero_corto,$cod_servicio) {
		$ventaPlanes = $this->db->query("select null numero_Corto
                                               ,null cod_servicio
                                               ,null nombre_plan
                                               ,null nombre_descriptivo
                                               ,null cantidad
                                               ,null monto
                                           from dual"
		                               ,"\upload\admin\model\sale\order.php->getOrder()");
	...
	public function getOrders($data = array()) {
		...
		$query = $this->db->query($sql,"\upload\admin\model\sale\order.php->getOrders()");
        */
		return $query->rows;
	}
	...
	public function getTotalOrders($data = array()) {
        ...
        */
		//Quitado
		//$query = $this->db->query($sql,"\upload\admin\model\sale\order.php->getTotalOrders");
	...
	public function getTotalOrdersByStoreId($store_id) {
		...
		$query = $this->db->query("SELECT COUNT(*) AS total FROM ` order` WHERE store_id = '" . (int)$store_id . "'"
		                         ,"\upload\admin\model\sale\order.php->getTotalOrdersByStoreId");
	...
	public function getTotalOrdersByOrderStatusId($order_status_id) {
		...
		$query = $this->db->query("SELECT COUNT(*) AS total FROM ` order` WHERE order_status_id = '" . (int)$order_status_id . "' AND order_status_id > '0'"
		                         ,"\upload\admin\model\sale\order.php->getTotalOrdersByOrderStatusId");
	...
	public function getTotalOrdersByProcessingStatus() {
		...
		if ($implode) {
			$query = $this->db->query("SELECT COUNT(*) AS total FROM ` order` WHERE " . implode(" OR ", $implode));
	...
	public function getEmailsByProductsOrdered($products, $start, $end) {
		...
		$query = $this->db->query("SELECT DISTINCT email FROM ` order` o LEFT JOIN  order_product op ON (o.order_id = op.order_id) WHERE (" . implode(" OR ", $implode) . ") AND o.order_status_id <> '0' LIMIT " . (int)$start . "," . (int)$end);
