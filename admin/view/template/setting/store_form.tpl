      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-store" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-fep" data-toggle="tab"><?php echo $tab_fep; ?></a></li>
            <li><a href="#tab-bmp" data-toggle="tab"><?php echo $tab_bmp; ?></a></li>
			<!--
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-ip_gdr"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_url); ?>"><?php echo $entry_url; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="ip_gdr" value="<?php echo $ip_gdr; ?>" placeholder="<?php echo $entry_url; ?>" id="input-url" class="form-control" />
                  <?php if ($error_gdr) { ?>
                  <div class="text-danger"><?php echo $error_gdr; ?></div>
                  <?php } ?>
                </div>
              </div>
			  <!-- IP PR -->
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-ip_gdr"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_url); ?>"><?php echo $entry_url; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_pr" value="<?php echo $ip_pr; ?>" placeholder="<?php echo $entry_url; ?>" id="input-url" class="form-control" />
                  <?php if ($error_pr) { ?>
                  <div class="text-danger"><?php echo $error_pr; ?></div>
                  <?php } ?>
                </div>
              </div>
			  
            </div>
            <div class="tab-pane" id="tab-fep">
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-fep_accountid"><?php echo "Account ID"; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_fep_accountid" value="<?php echo $config_fep_accountid; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name" class="form-control" />
                  <?php if ($error_name) { ?>
