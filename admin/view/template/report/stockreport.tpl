          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-right"><?php echo $column_inbounddate; ?></td>
                <td class="text-right"><?php echo $column_daysinventory; ?></td>
                <td class="text-right"><?php echo $column_hwcaja; ?></td>
                <td class="text-right"><?php echo $column_hwartcod; ?></td>

                <td class="text-left"><?php echo $column_hwartdesc; ?></td>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right"><?php echo $s['inbounddate']; ?></td>
                <td class="text-right"><?php echo $s['daysinventory']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/stockreport&token=<?php echo $token; ?>';
