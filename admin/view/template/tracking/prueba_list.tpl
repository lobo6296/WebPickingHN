  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="col-sm-4">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-mdr"><?php echo $entry_mdr; ?></label>
                <input type="text" name="filter_mdr" value="<?php echo $filter_mdr; ?>" placeholder="<?php echo $entry_mdr; ?>" id="input-mdr" class="form-control" />
              </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'hwmr') { ?>
                   ...
                   <td class="text-left"><?php echo $column_mdrno; ?></td>
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <td class="text-left"><?php echo $solicitud['hwmrno']; ?></td>
