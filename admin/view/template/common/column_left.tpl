<nav id="column-left">
  <div id="profile">
    <div>
      <?php if ($image) { ?>
      <img src="<?php echo $image; ?>" alt="<?php echo $firstname; ?> <?php echo $lastname; ?>" title="<?php echo $username; ?>" class="img-responsive" />
      <?php } else { ?>
      <!-- <i class="fa fa-bug"></i> -->
	  <img src="<?php echo "../image/cropa.png"; ?>" alt="Grupo CROPA" title="Grupo CROPA" class="img-responsive" />
      <?php } ?>
    </div>
    <div>
