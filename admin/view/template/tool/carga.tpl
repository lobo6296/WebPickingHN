    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $backup; ?>" method="post" enctype="multipart/form-data" id="form-backup" class="form-horizontal">
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo "Errores"; ?></label>
            <div class="col-sm-10">
              <div class="well well-sm" style="height: 150px; overflow: auto;">
                ...
                <div class="checkbox">
                  <label>
                    ...
                    <?php echo $error['err_code']." ".$error['err_msg']; ?>
				</label>
                </div>
                <?php } ?>
              </div>
...
$("document").ready(function(){
    $("#input-import").change(function() {
		var filename = $('input[name=\'import\']').val();
		filename= document.getElementById("input-import").files[0].name; 
